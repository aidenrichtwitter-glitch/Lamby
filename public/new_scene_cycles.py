...
BLEND = r"C:\Users\Aiden\Desktop\moonlit_garden.blend"

try:
    print("=" * 60)
    print("MOONLIT ZEN GARDEN — PHASE 2 (CYCLES COMPOSITE)")
    print("Same proven render config")
    print("=" * 60)
    ...
    for vl in scene.view_layers:
        ...
        ls.linestyle.color = (0.05, 0.05, 0.12)
    print("  Lineset: AnimeOutlines (dark indigo)")
    ...
    scene.render.filepath = f"{OUT}\\moonlit_garden_final.png"
    ...
    transfer = f"{OUT}\\moonlit_garden_transfer.jpg"
    img = bpy.data.images.get('Render Result')
    if img:
        img.save_render(filepath=transfer, scene=scene)
        print(f"  JPEG: {transfer}")

    print("\n=== OPEN RENDER IN VIEWER ===")
    import subprocess
    subprocess.Popen(['cmd', '/c', 'start', '', f"{OUT}\\moonlit_garden_final.png"], shell=False)
    print("  Opened render image")

    print("\n" + "=" * 60)
    print("PHASE 2 COMPLETE — Moonlit Zen Garden rendered")
    print("=" * 60)
