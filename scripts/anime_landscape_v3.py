...
# ═══════════════════════════════════════════════════════════════
# v3: EEVEE single-frame verification, focal-relative sizing
# ═══════════════════════════════════════════════════════════════
...
for name, cfg in MODELS.items():
    ...
    if root:
        ...
        if mn2:
            ...
            bpy.context.view_layer.update()
            print(f"  Placed: ({cfg['position'][0]}, {cfg['position'][1]}), final_h={h2:.3f}m")
    imported[name] = root
...
# ═══ EEVEE — FAST SINGLE FRAME VERIFICATION ═══
print("\n── EEVEE single-frame verify ──")
...
scene.frame_set(1)
verify_path = 'C:/Users/Aiden/Desktop/godmode-evidence/anime_v3_VERIFY.png'
...
# Save blend
blend_path = 'C:/Users/Aiden/Desktop/godmode-evidence/anime_landscape_v3.blend'
bpy.ops.wm.save_as_mainfile(filepath=blend_path)
print(f"Blend saved: {blend_path}")
print("\n═══ CHECK VERIFY FRAME — if girl is visible and prominent, run Cycles 10-frame render ═══")
